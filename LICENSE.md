...
> Discord logging bot, messages edits deletes voice events 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

📝 &nbsp;**Message logs** — deleted and edited messages logged instantly

👤 &nbsp;**Member events** — joins, leaves, bans, unbans

🔊 &nbsp;**Voice logs** — join, leave, move between channels

⚙️ &nbsp;**Server logs** — role, channel, and settings changes

🔍 &nbsp;**Search** — search logs by user or keyword

🗂️ &nbsp;**Separate channels** — route different log types to different channels
